  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        "body-small": ["var(--text-sm)", { lineHeight: "var(--leading-normal)", letterSpacing: "var(--tracking-body)", fontWeight: "var(--font-weight-body)" }],
        ...
        "form-error": ["var(--text-xs)", { lineHeight: "var(--leading-relaxed)", letterSpacing: "var(--tracking-normal)", fontWeight: "500" }],
        ...
        "metric-value": ["var(--text-2xl)", { lineHeight: "var(--leading-snug)", letterSpacing: "var(--tracking-tight)", fontWeight: "var(--font-weight-bold)" }],
        "heading-1": ["var(--text-5xl)", { lineHeight: "var(--leading-5xl)", letterSpacing: "var(--tracking-heading)", fontWeight: "var(--font-weight-bold)" }],
        "heading-2": ["var(--text-4xl)", { lineHeight: "var(--leading-4xl)", letterSpacing: "var(--tracking-heading)", fontWeight: "var(--font-weight-bold)" }],
        "heading-3": ["var(--text-3xl)", { lineHeight: "var(--leading-3xl)", letterSpacing: "var(--tracking-heading)", fontWeight: "var(--font-weight-semibold)" }],
        "heading-4": ["var(--text-2xl)", { lineHeight: "var(--leading-2xl)", letterSpacing: "var(--tracking-heading)", fontWeight: "var(--font-weight-semibold)" }],
        "heading-5": ["var(--text-xl)", { lineHeight: "var(--leading-xl)", letterSpacing: "var(--tracking-normal)", fontWeight: "var(--font-weight-semibold)" }],
      },
      lineHeight: {
